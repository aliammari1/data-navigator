...
| `sherpa-onnx-node` | voice-stt-tts | ~5k | Apache-2.0 | yes | ai-briefing, analytics-theater, voice | Installed. Native offline STT/TTS (Whisper-tiny + Kokoro). Wire read-aloud here instead of window.speechSynthesis. |
