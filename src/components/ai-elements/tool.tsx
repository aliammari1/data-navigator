...
// Localised for Moudir: this UI is French end-to-end and getStatusBadge is not
// prop-overridable, so the labels have to be changed here in the vendored file.
const statusLabels: Record<ToolPart["state"], string> = {
  "approval-requested": "Approbation requise",
  "approval-responded": "Répondu",
