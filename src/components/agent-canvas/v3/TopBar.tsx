...
import { Brain, Activity, Cpu, Hash } from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import { cn } from "@/lib/utils";
import { useAgentStore } from "@/lib/stores/agent-store";
import type { AgentPhase } from "@/lib/agent-canvas/types";
...
export function TopBar({ onReset }: Props) {
  ...
  return (
    <header className="h-10 shrink-0 bg-slate-950 border-b border-slate-800 flex items-center gap-3 px-4 overflow-hidden">
      {/* Logo */}
