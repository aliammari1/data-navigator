"use client";
/**
 * WidgetCardV3 — glassmorphism card with:
...
import { WidgetRendererV3 } from "./WidgetRendererV3";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 p-2">
        <WidgetRendererV3 widget={widget} height="100%" />
      </div>
