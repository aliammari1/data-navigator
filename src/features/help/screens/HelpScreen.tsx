...
const FEATURES = [
  ...
  },
  {
    ...
    summary:
      "Write and execute SQL queries against any loaded DuckDB table. Supports full DuckDB syntax: joins, window functions, aggregations.",
    tips: [
  ...
  },
  {
    ...
    summary:
      "Organise datasets into folders with tags and descriptions. Drag to reorder. Folders persist in localStorage.",
