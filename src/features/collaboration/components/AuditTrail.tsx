...
export function AuditTrail() {
  ...
  // Clearing wipes the shared audit log for every connected peer, so it is
  // gated behind the same owner-only flag as user management rather than the
  // broader "can edit" permission editors already have for comments/chat.
  const canClearAudit = access.permissions.canManageUsers;
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            disabled={!canClearAudit || auditEvents.length === 0}
          >
