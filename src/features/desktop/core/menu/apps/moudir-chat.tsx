...
/**
 * App-specific menus for the "moudir-chat" app (Moudir — Assistant IA).
 *
 * Moudir is the conversational agent-swarm assistant (single surface, no
 * internal pages), so we ship a tailored Fichier plus an "Analyse" menu.
 * Actions are wired to the screen's real handlers over the app-command bus
 * (`reset`, `cancel`) and to the `moudir:ask` channel via `ctx.askMoudir` for
