...
import { PeerPresenceOnSection } from "@/features/collaboration/components/PeerPresenceOnSection";
import { RemoteCursor } from "@/features/collaboration/components/RemoteCursor";
...
import {
  clearSectionCursor,
  publishPresence,
  publishSectionCursor,
} from "@/platform/lan/lan-collab";
import { cn } from "@/shared/utils";

const SECTION_ID = "status-config";
...
export function StatusConfigPanel({
  ...
  const remote = useRemoteCursors(SECTION_ID);
  useCurrentPage("status-config", SECTION_ID);
  ...
  return (
    <div className="relative space-y-5">
      ...
      <div ref={tableRef} className="relative space-y-1.5">
        {rawStatuses.map((rs, rowIndex) => {
