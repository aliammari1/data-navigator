      ...
      <CardContent>
        ...
        {!insight && !error && !generating && (
          <p className="text-sm text-muted-foreground">
            Generate a grounded, offline summary of the regional landscape —
            standout regions, regions needing attention (via seeded GESD/MAD
            anomaly detection), the dominant channel mix, and one recommendation.
            Every figure is taken from the active dataset; nothing is invented.
          </p>
        )}

        {generating && !insight && (
          <p className="text-sm text-muted-foreground">
            Running anomaly detection and narrating the regional aggregates
            offline…
          </p>
        )}
