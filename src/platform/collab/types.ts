...
// NOTE: the per-room provider transport types (CollabTransportStatus,
// CollabConnectOptions) were deleted with the second HocuspocusProvider —
// LAN transport is owned solely by `@/platform/lan/lan-collab`.
