...
// node_modules/@duckdb/duckdb-wasm/node_modules/apache-arrow/node_modules/flatbuffers/mjs/byte-buffer.js
class ByteBuffer {
  constructor(bytes_) {
    this.bytes_ = bytes_;
    this.position_ = 0;
...
// node_modules/@duckdb/duckdb-wasm/node_modules/apache-arrow/node_modules/flatbuffers/mjs/builder.js
class Builder {
...
// node_modules/@duckdb/duckdb-wasm/node_modules/apache-arrow/node_modules/flatbuffers/mjs/flatbuffers.js
...
var exports_duckdb_browser = {};
__export(exports_duckdb_browser, {
  selectBundle: () => Xe,
  isSafari: () => ze,
  isNode: () => x,
  isFirefox: () => Ve,
  getPlatformFeatures: () => pe,
  getLogTopicLabel: () => Ie,
  getLogOriginLabel: () => ke,
  getLogLevelLabel: () => Te,
  getLogEventLabel: () => be,
  getJsDelivrBundles: () => Je,
  createWorker: () => er,
  WorkerTask: () => a,
  WorkerResponseType: () => O,
  WorkerRequestType: () => D,
  VoidLogger: () => N,
  TokenType: () => re,
  StatusCode: () => ie,
  PACKAGE_VERSION_PATCH: () => Ye,
  PACKAGE_VERSION_MINOR: () => qe,
  PACKAGE_VERSION_MAJOR: () => He,
  PACKAGE_VERSION: () => G,
  PACKAGE_NAME: () => M,
  LogTopic: () => se,
  LogOrigin: () => oe,
  LogLevel: () => te,
  LogEvent: () => ne,
  IsDuckDBWasmRetry: () => Se,
  IsArrowBuffer: () => ge,
  DuckDBDataProtocol: () => w,
  DuckDBAccessMode: () => ee,
  ConsoleLogger: () => A,
...
function _(s) {
  switch (s.typeId) {
    ...
    case Type2.TimeSecond:
      return { sqlType: "time[s]" };
    case Type2.Timestamp:
      return { sqlType: "timestamp", timezone: s.timezone || undefined };
    case Type2.TimestampSecond:
      return { sqlType: "timestamp[s]", timezone: s.timezone || undefined };
    case Type2.TimestampMicrosecond:
      return { sqlType: "timestamp[us]", timezone: s.timezone || undefined };
    case Type2.TimestampNanosecond:
      return { sqlType: "timestamp[ns]", timezone: s.timezone || undefined };
    case Type2.TimestampMillisecond:
      return { sqlType: "timestamp[ms]", timezone: s.timezone || undefined };
  }
